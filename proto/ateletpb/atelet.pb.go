...
// SecurityContext mirrors `api/v1alpha1.ContainerSecurityContext` over the
// wire. Only `Capabilities.Add` is honored by atelet's OCI bundle builder
// today.
...
// Capabilities mirrors `api/v1alpha1.Capabilities`. Each `add`/`drop` entry
