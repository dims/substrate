...
// Command ateom-uvm is the kata + cloud-hypervisor micro-VM
...
var (
	...
	// reapLock guards subprocess exec against the child reaper: ateom-uvm
...
func do(ctx context.Context) error {
	...
	slog.InfoContext(ctx, "ateom-uvm booting", slog.String("version", version.String()))

	tp, err := serverboot.InitTracing(ctx, serverboot.TracingOptions{
		ServiceName: "ateom-uvm",
	...
	slog.InfoContext(ctx, "ateom-uvm serving", slog.String("socket", sockPath))
